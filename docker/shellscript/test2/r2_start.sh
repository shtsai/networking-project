...
# --network=r2 specifies the default network to which this container is attached. This network is used to connect to the Internet.
# --name r2 specifies the name of this container
...
#
docker run -ti --privileged --cap-add NET_ADMIN --network=r2 --name r2 shtsai7/server:router /bin/bash
